...
class ConvertedCurrencySchema(BaseModel):
    ...
    converted_amount: Union[StrictFloat, StrictInt] = Field(alias="convertedAmount")
    __properties: ClassVar[List[str]] = ["baseCurrency", "targetCurrency", "rate", "amount", "convertedAmount"]
